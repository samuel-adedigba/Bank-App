...
export const COLOR_1 = colors.indigo[600]
export const COLOR_2 = colors.blue[500]
export const COLOR_3 = colors.emerald[500]
export const COLOR_4 = colors.amber[500]
export const COLOR_5 = colors.red[500]
export const COLOR_6 = colors.purple[500]
export const COLOR_7 = colors.cyan[500]

export const COLOR_1_LIGHT = colors.indigo[100]
export const COLOR_2_LIGHT = colors.blue[100]
export const COLOR_3_LIGHT = colors.emerald[100]
export const COLOR_4_LIGHT = colors.amber[100]
export const COLOR_5_LIGHT = colors.red[100]
export const COLOR_6_LIGHT = colors.purple[100]
export const COLOR_7_LIGHT = colors.cyan[100]
