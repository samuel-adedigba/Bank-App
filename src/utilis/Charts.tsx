...
import { apexLineChartDefaultOption, apexBarChartDefaultOption,
        apexAreaChartDefaultOption,
         apexDonutChartDefaultOption,
         apexMonochromePieChartDefaultOption, } from '../components/config/chart.config'
    ...
    const chartDefaultOption = useMemo(() => {
        switch (type) {
            ...
            case 'donut':
                ...
                case 'pie':
                    return apexMonochromePieChartDefaultOption
            default:
                return apexLineChartDefaultOption
        }
    }, [type])
